...
* The original package name 'cl.duoc.andesstay.ms-andesstay-reservations' is invalid and this project uses 'cl.duoc.andesstay.ms_andesstay_reservations' instead.
